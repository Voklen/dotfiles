...
local menu = "fuzzel"
local logout = "pkill wlogout; wlogout"
...
hl.bind(mainMod .. " + CONTROL + TAB", hl.dsp.exec_cmd(terminal))
...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd("keepassxc"))
...
-- Screenshots
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m output")) -- Full monitor
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("hyprshot -m output")) -- Full monitor on laptop
hl.bind("SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region")) -- Select region
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("hyprshot -m region")) -- Select region on laptop

-- Move focus with mainMod + QWERTY vim keys on dvorak
...
-- Power key
hl.bind("XF86PowerOff", hl.dsp.exec_cmd(logout), { locked = true, repeating = true })
