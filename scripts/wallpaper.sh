...
echo "$random_file" >"$(dirname "$destination_file")/wallpaper_location"

# Link the random file to the destination
rm "$destination_file"
ln "$random_file" "$destination_file"

hyprctl hyprpaper wallpaper ",$destination_file"
